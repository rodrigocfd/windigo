...
// Constructor.
func newEventsWindow(wndTy _WNDTY) WindowEvents {
...
func (me *WindowEvents) removeWmCreateInitdialog() {
	me.wmCreate = nil
	me.wmInitDialog = nil
}

// Releases the memory of all closures.
func (me *WindowEvents) clear() {
...
func (me *WindowEvents) hasMessage() bool {
...
func (me *WindowEvents) processLast(p Wm) (userRet uintptr, wasHandled bool) {
	switch p.Msg {
	case co.WM_CREATE:
		if me.wmCreate != nil {
...
// receive [WindowEvents.WmInitDialog] instead.
//
// Example:
//
...
func (me *WindowEvents) WmCreate(fun func(p WmCreate) int) {
	me.wmCreate = fun
}
...
// [CreateWindowEx]: https://learn.microsoft.com/en-us/windows/win32/api/winuser/nf-winuser-createwindowexw
func (me *WindowEvents) WmInitDialog(fun func(p WmInitDialog) bool) {
	me.wmInitDialog = fun
}
...
func (me *WindowEvents) Wm(id co.WM, fun func(p Wm) uintptr) {
...
func (me *WindowEvents) WmCommand(cmdId uint16, notifCode co.CMD, fun func()) {
...
//
// [WM_COMMAND]: https://learn.microsoft.com/en-us/windows/win32/menurc/wm-command
func (me *WindowEvents) WmCommandAccelMenu(cmdId uint16, fun func()) {
...
func (me *WindowEvents) WmNotify(idFrom uint16, code co.NM, fun func(p unsafe.Pointer) uintptr) {
...
func (me *WindowEvents) WmActivate(fun func(p WmActivate)) {
...
func (me *WindowEvents) WmActivateApp(fun func(p WmActivateApp)) {
...
func (me *WindowEvents) WmAppCommand(fun func(p WmAppCommand)) {
...
func (me *WindowEvents) WmAskCbFormatName(fun func(p WmAskCbFormatName)) {
...
func (me *WindowEvents) WmCancelMode(fun func()) {
...
func (me *WindowEvents) WmCaptureChanged(fun func(p WmCaptureChanged)) {
...
func (me *WindowEvents) WmChangeCbChain(fun func(p WmChangeCbChain)) {
...
func (me *WindowEvents) WmChar(fun func(p WmChar)) {
...
func (me *WindowEvents) WmCharToItem(fun func(p WmCharToItem) int) {
...
func (me *WindowEvents) WmChildActivate(fun func()) {
...
func (me *WindowEvents) WmClipboardUpdate(fun func()) {
...
func (me *WindowEvents) WmClose(fun func()) {
...
func (me *WindowEvents) WmCompareItem(fun func(p WmCompareItem) int) {
...
func (me *WindowEvents) WmContextMenu(fun func(p WmContextMenu)) {
...
func (me *WindowEvents) WmCopyData(fun func(p WmCopyData) bool) {
...
func (me *WindowEvents) WmCtlColorBtn(fun func(p WmCtlColor) win.HBRUSH) {
...
func (me *WindowEvents) WmCtlColorDlg(fun func(p WmCtlColor) win.HBRUSH) {
...
func (me *WindowEvents) WmCtlColorEdit(fun func(p WmCtlColor) win.HBRUSH) {
...
func (me *WindowEvents) WmCtlColorListBox(fun func(p WmCtlColor) win.HBRUSH) {
...
func (me *WindowEvents) WmCtlColorScrollBar(fun func(p WmCtlColor) win.HBRUSH) {
...
func (me *WindowEvents) WmCtlColorStatic(fun func(p WmCtlColor) win.HBRUSH) {
...
func (me *WindowEvents) WmDeadChar(fun func(p WmChar)) {
...
func (me *WindowEvents) WmDeleteItem(fun func(p WmDeleteItem)) {
...
func (me *WindowEvents) WmDestroy(fun func()) {
...
func (me *WindowEvents) WmDestroyClipboard(fun func()) {
...
func (me *WindowEvents) WmDeviceChange(fun func(WmDeviceChange) co.BROADCAST_QUERY) {
...
func (me *WindowEvents) WmDevModeChange(fun func(WmDevModeChange)) {
...
func (me *WindowEvents) WmDisplayChange(fun func(p WmDisplayChange)) {
...
func (me *WindowEvents) WmDrawClipboard(fun func()) {
...
func (me *WindowEvents) WmDrawItem(fun func(p WmDrawItem)) {
...
func (me *WindowEvents) WmDropFiles(fun func(p WmDropFiles)) {
...
func (me *WindowEvents) WmDwmColorizationColorChanged(fun func(p WmDwmColorizationColorChanged)) {
...
func (me *WindowEvents) WmDwmCompositionChanged(fun func()) {
...
func (me *WindowEvents) WmDwmNcRenderingChanged(fun func(p WmDwmNcRenderingChanged)) {
...
func (me *WindowEvents) WmDwmSendIconicLivePreviewBitmap(fun func()) {
...
func (me *WindowEvents) WmDwmSendIconicThumbnail(fun func(p WmDwmSendIconicThumbnail)) {
...
func (me *WindowEvents) WmDwmWindowMaximizedChange(fun func(p WmDwmWindowMaximizedChange)) {
...
func (me *WindowEvents) WmEnable(fun func(p WmEnable)) {
...
func (me *WindowEvents) WmEndSession(fun func(p WmEndSession)) {
...
func (me *WindowEvents) WmEnterIdle(fun func(p WmEnterIdle)) {
...
func (me *WindowEvents) WmEnterMenuLoop(fun func(WmEnterMenuLoop)) {
...
func (me *WindowEvents) WmEnterSizeMove(fun func()) {
...
func (me *WindowEvents) WmEraseBkgnd(fun func(WmEraseBkgnd) int) {
...
func (me *WindowEvents) WmExitMenuLoop(fun func(WmExitMenuLoop)) {
...
func (me *WindowEvents) WmExitSizeMove(fun func()) {
...
func (me *WindowEvents) WmFontChange(fun func()) {
...
func (me *WindowEvents) WmGetDlgCode(fun func(p WmGetDlgCode) co.DLGC) {
...
func (me *WindowEvents) WmGetFont(fun func() win.HFONT) {
...
func (me *WindowEvents) WmGetHMenu(fun func() win.HMENU) {
...
func (me *WindowEvents) WmGetIcon(fun func(p WmGetIcon) win.HICON) {
...
func (me *WindowEvents) WmGetMinMaxInfo(fun func(p WmGetMinMaxInfo)) {
...
func (me *WindowEvents) WmGetText(fun func(p WmGetText) int) {
...
func (me *WindowEvents) WmGetTextLength(fun func() int) {
...
func (me *WindowEvents) WmGetTitleBarInfoEx(fun func(p WmGetTitleBarInfoEx)) {
...
func (me *WindowEvents) WmHelp(fun func(p WmHelp)) {
...
func (me *WindowEvents) WmHotKey(fun func(p WmHotKey)) {
...
func (me *WindowEvents) WmHScroll(fun func(p WmScroll)) {
...
func (me *WindowEvents) WmHScrollClipboard(fun func(p WmScrollClipboard)) {
...
func (me *WindowEvents) WmInitMenuPopup(fun func(p WmInitMenuPopup)) {
...
func (me *WindowEvents) WmKeyDown(fun func(p WmKey)) {
...
func (me *WindowEvents) WmKeyUp(fun func(p WmKey)) {
...
func (me *WindowEvents) WmKillFocus(fun func(p WmKillFocus)) {
...
func (me *WindowEvents) WmLButtonDblClk(fun func(p WmMouse)) {
...
func (me *WindowEvents) WmLButtonDown(fun func(p WmMouse)) {
...
func (me *WindowEvents) WmLButtonUp(fun func(p WmMouse)) {
...
func (me *WindowEvents) WmMButtonDblClk(fun func(p WmMouse)) {
...
func (me *WindowEvents) WmMButtonDown(fun func(p WmMouse)) {
...
func (me *WindowEvents) WmMButtonUp(fun func(p WmMouse)) {
...
func (me *WindowEvents) WmMenuChar(fun func(p WmMenuChar) co.MNC) {
...
func (me *WindowEvents) WmMenuCommand(fun func(p WmMenu)) {
...
func (me *WindowEvents) WmMenuDrag(fun func(p WmMenu) co.MND) {
...
func (me *WindowEvents) WmMenuGetObject(fun func(p WmMenuGetObject) co.MNGO) {
...
func (me *WindowEvents) WmMenuRButtonUp(fun func(p WmMenu)) {
...
func (me *WindowEvents) WmMenuSelect(fun func(p WmMenuSelect)) {
...
func (me *WindowEvents) WmMouseHover(fun func(p WmMouse)) {
...
func (me *WindowEvents) WmMouseLeave(fun func()) {
...
func (me *WindowEvents) WmMouseMove(fun func(p WmMouse)) {
...
func (me *WindowEvents) WmMove(fun func(p WmMove)) {
...
func (me *WindowEvents) WmMoving(fun func(p WmMoving)) {
...
func (me *WindowEvents) WmNcActivate(fun func(p WmNcActivate) bool) {
...
func (me *WindowEvents) WmNcCalcSize(fun func(p WmNcCalcSize) co.WVR) {
...
func (me *WindowEvents) WmNcCreate(fun func(p WmCreate) bool) {
...
func (me *WindowEvents) WmNcDestroy(fun func()) {
...
func (me *WindowEvents) WmNcHitTest(fun func(WmNcHitTest) co.HT) {
...
func (me *WindowEvents) WmNcLButtonDblClk(fun func(p WmNcMouse)) {
...
func (me *WindowEvents) WmNcLButtonDown(fun func(p WmNcMouse)) {
...
func (me *WindowEvents) WmNcLButtonUp(fun func(p WmNcMouse)) {
...
func (me *WindowEvents) WmNcMButtonDblClk(fun func(p WmNcMouse)) {
...
func (me *WindowEvents) WmNcMButtonDown(fun func(p WmNcMouse)) {
...
func (me *WindowEvents) WmNcMButtonUp(fun func(p WmNcMouse)) {
...
func (me *WindowEvents) WmNcMouseHover(fun func(p WmNcMouse)) {
...
func (me *WindowEvents) WmNcMouseLeave(fun func()) {
...
func (me *WindowEvents) WmNcMouseMove(fun func(p WmNcMouse)) {
...
func (me *WindowEvents) WmNcPaint(fun func(p WmNcPaint)) {
...
func (me *WindowEvents) WmNcRButtonDblClk(fun func(p WmNcMouse)) {
...
func (me *WindowEvents) WmNcRButtonDown(fun func(p WmNcMouse)) {
...
func (me *WindowEvents) WmNcRButtonUp(fun func(p WmNcMouse)) {
...
func (me *WindowEvents) WmNcXButtonDblClk(fun func(p WmNcMouseX)) {
...
func (me *WindowEvents) WmNcXButtonDown(fun func(p WmNcMouseX)) {
...
func (me *WindowEvents) WmNcXButtonUp(fun func(p WmNcMouseX)) {
...
func (me *WindowEvents) WmNextDlgCtl(fun func(p WmNextDlgCtl)) {
...
func (me *WindowEvents) WmNextMenu(fun func(p WmNextMenu)) {
...
func (me *WindowEvents) WmNull(fun func()) {
...
func (me *WindowEvents) WmPaint(fun func()) {
...
func (me *WindowEvents) WmPaintClipboard(fun func(WmPaintClipboard)) {
...
func (me *WindowEvents) WmParentNotify(fun func(WmParentNotify)) {
...
func (me *WindowEvents) WmPowerBroadcast(fun func(p WmPowerBroadcast)) {
...
func (me *WindowEvents) WmPrint(fun func(p WmPrint)) {
...
func (me *WindowEvents) WmQueryDragIcon(fun func() win.HICON) {
...
func (me *WindowEvents) WmQueryOpen(fun func() bool) {
...
func (me *WindowEvents) WmRButtonDblClk(fun func(p WmMouse)) {
...
func (me *WindowEvents) WmRButtonDown(fun func(p WmMouse)) {
...
func (me *WindowEvents) WmRButtonUp(fun func(p WmMouse)) {
...
func (me *WindowEvents) WmRenderAllFormats(fun func()) {
...
func (me *WindowEvents) WmRenderFormat(fun func(p WmRenderFormat)) {
...
func (me *WindowEvents) WmSetCursor(fun func(p WmSetCursor) bool) {
...
func (me *WindowEvents) WmSetFocus(fun func(p WmSetFocus)) {
...
func (me *WindowEvents) WmSetFont(fun func(p WmSetFont)) {
...
func (me *WindowEvents) WmSetIcon(fun func(p WmSetIcon) win.HICON) {
...
func (me *WindowEvents) WmSetRedraw(fun func(p WmSetRedraw)) {
...
func (me *WindowEvents) WmSetText(fun func(p WmSetText) uintptr) {
...
func (me *WindowEvents) WmShowWindow(fun func(p WmShowWindow)) {
...
func (me *WindowEvents) WmSize(fun func(p WmSize)) {
...
func (me *WindowEvents) WmSizeClipboard(fun func(p WmSizeClipboard)) {
...
func (me *WindowEvents) WmSizing(fun func(p WmSizing)) {
...
func (me *WindowEvents) WmStyleChanged(fun func(p WmStyles)) {
...
func (me *WindowEvents) WmStyleChanging(fun func(p WmStyles)) {
...
func (me *WindowEvents) WmSyncPaint(fun func()) {
...
func (me *WindowEvents) WmSysChar(fun func(p WmChar)) {
...
func (me *WindowEvents) WmSysCommand(fun func(p WmSysCommand)) {
...
func (me *WindowEvents) WmSysDeadChar(fun func(p WmChar)) {
...
func (me *WindowEvents) WmSysKeyDown(fun func(p WmKey)) {
...
func (me *WindowEvents) WmSysKeyUp(fun func(p WmKey)) {
...
func (me *WindowEvents) WmThemeChanged(fun func()) {
...
func (me *WindowEvents) WmTimeChange(fun func()) {
...
func (me *WindowEvents) WmUnInitMenuPopup(fun func(p WmUnInitMenuPopup)) {
...
func (me *WindowEvents) WmUndo(fun func() bool) {
...
func (me *WindowEvents) WmVScroll(fun func(p WmScroll)) {
...
func (me *WindowEvents) WmVScrollClipboard(fun func(p WmScrollClipboard)) {
...
func (me *WindowEvents) WmWindowPosChanged(fun func(p WmWindowPos)) {
...
func (me *WindowEvents) WmWindowPosChanging(fun func(p WmWindowPos)) {
...
func (me *WindowEvents) WmWtsSessionChange(fun func(p WmWtsSessionChange)) {
...
func (me *WindowEvents) WmXButtonDblClk(fun func(p WmMouse)) {
...
func (me *WindowEvents) WmXButtonDown(fun func(p WmMouse)) {
...
func (me *WindowEvents) WmXButtonUp(fun func(p WmMouse)) {

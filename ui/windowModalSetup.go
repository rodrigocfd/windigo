...
func makeWindowModalSetup() windowModalSetup {
	return windowModalSetup{
		ClassStyle: c.CS_DBLCLKS,

		Width:   500, // arbitrary dimensions
		Height:  400,
		Style:   c.WS_CAPTION | c.WS_SYSMENU | c.WS_CLIPCHILDREN | c.WS_BORDER | c.WS_VISIBLE,
		ExStyle: c.WS_EX(0),
	}
}

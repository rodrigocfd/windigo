...
func (p WmChar) IsExtendedKey() bool { return util.BitIsSet(win.HIBYTE(p.Raw.LParam.HiWord()), 0) }
func (p WmChar) HasAltKey() bool     { return util.BitIsSet(win.HIBYTE(p.Raw.LParam.HiWord()), 5) }
func (p WmChar) IsKeyDownBeforeSend() bool {
	return util.BitIsSet(win.HIBYTE(p.Raw.LParam.HiWord()), 6)
}
func (p WmChar) IsKeyBeingReleased() bool { return util.BitIsSet(win.HIBYTE(p.Raw.LParam.HiWord()), 7) }
...
func (p WmKey) IsExtendedKey() bool       { return util.BitIsSet(win.HIBYTE(p.Raw.LParam.HiWord()), 0) }
func (p WmKey) HasAltKey() bool           { return util.BitIsSet(win.HIBYTE(p.Raw.LParam.HiWord()), 5) }
func (p WmKey) IsKeyDownBeforeSend() bool { return util.BitIsSet(win.HIBYTE(p.Raw.LParam.HiWord()), 6) }
func (p WmKey) IsReleasingKey() bool      { return util.BitIsSet(win.HIBYTE(p.Raw.LParam.HiWord()), 7) }

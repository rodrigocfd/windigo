...
const (
	CBS_AUTOHSCROLL       CBS = 0x00000040
	CBS_DISABLENOSCROLL   CBS = 0x00000800
	CBS_DROPDOWN          CBS = 0x00000002
	CBS_DROPDOWNLIST      CBS = 0x00000003
	CBS_HASSTRINGS        CBS = 0x00000200
	CBS_LOWERCASE         CBS = 0x00004000
	CBS_NOINTEGRALHEIGHT  CBS = 0x00000400
	CBS_OWNERDRAWFIXED    CBS = 0x00000010
	CBS_OWNERDRAWVARIABLE CBS = 0x00000020
	CBS_SIMPLE            CBS = 0x00000001
	CBS_SORT              CBS = 0x00000100
	CBS_UPPERCASE         CBS = 0x00002000
)

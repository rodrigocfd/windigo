...
const (
	LVCFMT_LEFT        LVCFMT = 0x0000
	LVCFMT_RIGHT       LVCFMT = 0x0001
	LVCFMT_CENTER      LVCFMT = 0x0002
	LVCFMT_JUSTIFYMASK LVCFMT = 0x0003

	LVCFMT_IMAGE           LVCFMT = 0x0800
	LVCFMT_BITMAP_ON_RIGHT LVCFMT = 0x1000
	LVCFMT_COL_HAS_IMAGES  LVCFMT = 0x8000

	LVCFMT_FIXED_WIDTH  LVCFMT = 0x00100
	LVCFMT_NO_DPI_SCALE LVCFMT = 0x40000
	LVCFMT_FIXED_RATIO  LVCFMT = 0x80000

	LVCFMT_LINE_BREAK         LVCFMT = 0x100000
	LVCFMT_FILL               LVCFMT = 0x200000
	LVCFMT_WRAP               LVCFMT = 0x400000
	LVCFMT_NO_TITLE           LVCFMT = 0x800000
	LVCFMT_TILE_PLACEMENTMASK LVCFMT = LVCFMT_LINE_BREAK | LVCFMT_FILL

	LVCFMT_SPLITBUTTON LVCFMT = 0x1000000
)

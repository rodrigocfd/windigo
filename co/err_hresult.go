...
const (
	...
	HRESULT_DXGI_ERROR_INVALID_CALL                  HRESULT = 0x887a_0001 // The application made a call that is invalid. Either the parameters of the call or the state of some object was incorrect. Enable the D3D debug layer in order to see details via debug messages.
	HRESULT_DXGI_ERROR_NOT_FOUND                     HRESULT = 0x887a_0002 // The object was not found. If calling IDXGIFactory::EnumAdaptes, there is no adapter with the specified ordinal.
	HRESULT_DXGI_ERROR_MORE_DATA                     HRESULT = 0x887a_0003 // The caller did not supply a sufficiently large buffer.
	HRESULT_DXGI_ERROR_UNSUPPORTED                   HRESULT = 0x887a_0004 // The specified device interface or feature level is not supported on this system.
	HRESULT_DXGI_ERROR_DEVICE_REMOVED                HRESULT = 0x887a_0005 // The GPU device instance has been suspended. Use GetDeviceRemovedReason to determine the appropriate action.
	HRESULT_DXGI_ERROR_DEVICE_HUNG                   HRESULT = 0x887a_0006 // The GPU will not respond to more commands, most likely because of an invalid command passed by the calling application.
	HRESULT_DXGI_ERROR_DEVICE_RESET                  HRESULT = 0x887a_0007 // The GPU will not respond to more commands, most likely because some other application submitted invalid commands. The calling application should re-create the device and continue.
	HRESULT_DXGI_ERROR_WAS_STILL_DRAWING             HRESULT = 0x887a_000a // The GPU was busy at the moment when the call was made, and the call was neither executed nor scheduled.
	HRESULT_DXGI_ERROR_FRAME_STATISTICS_DISJOINT     HRESULT = 0x887a_000b // An event (such as power cycle) interrupted the gathering of presentation statistics. Any previous statistics should be considered invalid.
	HRESULT_DXGI_ERROR_GRAPHICS_VIDPN_SOURCE_IN_USE  HRESULT = 0x887a_000c // Fullscreen mode could not be achieved because the specified output was already in use.
	HRESULT_DXGI_ERROR_DRIVER_INTERNAL_ERROR         HRESULT = 0x887a_0020 // An internal issue prevented the driver from carrying out the specified operation. The driver's state is probably suspect, and the application should not continue.
	HRESULT_DXGI_ERROR_NONEXCLUSIVE                  HRESULT = 0x887a_0021 // A global counter resource was in use, and the specified counter cannot be used by this Direct3D device at this time.
	HRESULT_DXGI_ERROR_NOT_CURRENTLY_AVAILABLE       HRESULT = 0x887a_0022 // A resource is not available at the time of the call, but may become available later.
	HRESULT_DXGI_ERROR_REMOTE_CLIENT_DISCONNECTED    HRESULT = 0x887a_0023 // The application's remote device has been removed due to session disconnect or network disconnect. The application should call IDXGIFactory1::IsCurrent to find out when the remote device becomes available again.
	HRESULT_DXGI_ERROR_REMOTE_OUTOFMEMORY            HRESULT = 0x887a_0024 // The device has been removed during a remote session because the remote computer ran out of memory.
	HRESULT_DXGI_ERROR_ACCESS_LOST                   HRESULT = 0x887a_0026 // The keyed mutex was abandoned.
	HRESULT_DXGI_ERROR_WAIT_TIMEOUT                  HRESULT = 0x887a_0027 // The timeout value has elapsed and the resource is not yet available.
	HRESULT_DXGI_ERROR_SESSION_DISCONNECTED          HRESULT = 0x887a_0028 // The output duplication has been turned off because the Windows session ended or was disconnected. This happens when a remote user disconnects, or when "switch user" is used locally.
	HRESULT_DXGI_ERROR_RESTRICT_TO_OUTPUT_STALE      HRESULT = 0x887a_0029 // The DXGI output (monitor) to which the swapchain content was restricted, has been disconnected or changed.
	HRESULT_DXGI_ERROR_CANNOT_PROTECT_CONTENT        HRESULT = 0x887a_002a // DXGI is unable to provide content protection on the swapchain. This is typically caused by an older driver, or by the application using a swapchain that is incompatible with content protection.
	HRESULT_DXGI_ERROR_ACCESS_DENIED                 HRESULT = 0x887a_002b // The application is trying to use a resource to which it does not have the required access privileges. This is most commonly caused by writing to a shared resource with read-only access.
	HRESULT_DXGI_ERROR_NAME_ALREADY_EXISTS           HRESULT = 0x887a_002c // The application is trying to create a shared handle using a name that is already associated with some other resource.
	HRESULT_DXGI_ERROR_SDK_COMPONENT_MISSING         HRESULT = 0x887a_002d // The application requested an operation that depends on an SDK component that is missing or mismatched.
	HRESULT_DXGI_ERROR_NOT_CURRENT                   HRESULT = 0x887a_002e // The DXGI objects that the application has created are no longer current & need to be recreated for this operation to be performed.
	HRESULT_DXGI_ERROR_HW_PROTECTION_OUTOFMEMORY     HRESULT = 0x887a_0030 // Insufficient HW protected memory exits for proper function.
	HRESULT_DXGI_ERROR_DYNAMIC_CODE_POLICY_VIOLATION HRESULT = 0x887a_0031 // Creating this device would violate the process's dynamic code policy.
	HRESULT_DXGI_ERROR_NON_COMPOSITED_UI             HRESULT = 0x887a_0032 // The operation failed because the compositor is not in control of the output.
	HRESULT_DXGI_ERROR_MODE_CHANGE_IN_PROGRESS       HRESULT = 0x887a_0025 // An on-going mode change prevented completion of the call. The call may succeed if attempted later.
	HRESULT_DXGI_ERROR_CACHE_CORRUPT                 HRESULT = 0x887a_0033 // The cache is corrupt and either could not be opened or could not be reset.
	HRESULT_DXGI_ERROR_CACHE_FULL                    HRESULT = 0x887a_0034 // This entry would cause the cache to exceed its quota. On a load operation, this may indicate exceeding the maximum in-memory size.
	HRESULT_DXGI_ERROR_CACHE_HASH_COLLISION          HRESULT = 0x887a_0035 // A cache entry was found, but the key provided does not match the key stored in the entry.
	HRESULT_DXGI_ERROR_ALREADY_EXISTS                HRESULT = 0x887a_0036 // The desired element already exists.
	HRESULT_DXGI_ERROR_MPO_UNPINNED                  HRESULT = 0x887a_0064 // The allocation of the MPO plane has been unpinned.
	HRESULT_DXGI_ERROR_SETDISPLAYMODE_REQUIRED       HRESULT = 0x887a_0065 // SetDisplayMode is required before present can succeed.
	...
	HRESULT_TYPE_E_BUFFERTOOSMALL          HRESULT = 0x8002_8016 // Buffer too small.
	HRESULT_TYPE_E_FIELDNOTFOUND           HRESULT = 0x8002_8017 // Field name not defined in the record.
	HRESULT_TYPE_E_INVDATAREAD             HRESULT = 0x8002_8018 // Old format or invalid type library.
	HRESULT_TYPE_E_UNSUPFORMAT             HRESULT = 0x8002_8019 // Old format or invalid type library.
	HRESULT_TYPE_E_REGISTRYACCESS          HRESULT = 0x8002_801c // Error accessing the OLE registry.
	HRESULT_TYPE_E_LIBNOTREGISTERED        HRESULT = 0x8002_801d // Library not registered.
	HRESULT_TYPE_E_UNDEFINEDTYPE           HRESULT = 0x8002_8027 // Bound to unknown type.
	HRESULT_TYPE_E_QUALIFIEDNAMEDISALLOWED HRESULT = 0x8002_8028 // Qualified name disallowed.
	HRESULT_TYPE_E_INVALIDSTATE            HRESULT = 0x8002_8029 // Invalid forward reference, or reference to uncompiled type.
	HRESULT_TYPE_E_WRONGTYPEKIND           HRESULT = 0x8002_802a // Type mismatch.
	HRESULT_TYPE_E_ELEMENTNOTFOUND         HRESULT = 0x8002_802b // Element not found.
	HRESULT_TYPE_E_AMBIGUOUSNAME           HRESULT = 0x8002_802c // Ambiguous name.
	HRESULT_TYPE_E_NAMECONFLICT            HRESULT = 0x8002_802d // Name already exists in the library.
	HRESULT_TYPE_E_UNKNOWNLCID             HRESULT = 0x8002_802e // Unknown LCID.
	HRESULT_TYPE_E_DLLFUNCTIONNOTFOUND     HRESULT = 0x8002_802f // Function not defined in specified DLL.
	HRESULT_TYPE_E_BADMODULEKIND           HRESULT = 0x8002_88bd // Wrong module kind for the operation.
	HRESULT_TYPE_E_SIZETOOBIG              HRESULT = 0x8002_88c5 // Size may not exceed 64K.
	HRESULT_TYPE_E_DUPLICATEID             HRESULT = 0x8002_88c6 // Duplicate ID in inheritance hierarchy.
	HRESULT_TYPE_E_INVALIDID               HRESULT = 0x8002_88cf // Incorrect inheritance depth in standard OLE hmember.
	HRESULT_TYPE_E_TYPEMISMATCH            HRESULT = 0x8002_8ca0 // Type mismatch.
	HRESULT_TYPE_E_OUTOFBOUNDS             HRESULT = 0x8002_8ca1 // Invalid number of arguments.
	HRESULT_TYPE_E_IOERROR                 HRESULT = 0x8002_8ca2 // I/O Error.
	HRESULT_TYPE_E_CANTCREATETMPFILE       HRESULT = 0x8002_8ca3 // Error creating unique tmp file.
	HRESULT_TYPE_E_CANTLOADLIBRARY         HRESULT = 0x8002_9c4a // Error loading type library/DLL.
	HRESULT_TYPE_E_INCONSISTENTPROPFUNCS   HRESULT = 0x8002_9c83 // Inconsistent property functions.
	HRESULT_TYPE_E_CIRCULARTYPE            HRESULT = 0x8002_9c84 // Circular dependency between types/modules.

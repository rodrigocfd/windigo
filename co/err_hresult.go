...
const (
	...
	HRESULT_CTL_E_ILLEGALFUNCTIONCALL       HRESULT = 1<<31 | 10<<16 | 5
	HRESULT_CTL_E_OVERFLOW                  HRESULT = 1<<31 | 10<<16 | 6
	HRESULT_CTL_E_OUTOFMEMORY               HRESULT = 1<<31 | 10<<16 | 7
	HRESULT_CTL_E_DIVISIONBYZERO            HRESULT = 1<<31 | 10<<16 | 11
	HRESULT_CTL_E_OUTOFSTRINGSPACE          HRESULT = 1<<31 | 10<<16 | 14
	HRESULT_CTL_E_OUTOFSTACKSPACE           HRESULT = 1<<31 | 10<<16 | 28
	HRESULT_CTL_E_BADFILENAMEORNUMBER       HRESULT = 1<<31 | 10<<16 | 52
	HRESULT_CTL_E_FILENOTFOUND              HRESULT = 1<<31 | 10<<16 | 53
	HRESULT_CTL_E_BADFILEMODE               HRESULT = 1<<31 | 10<<16 | 54
	HRESULT_CTL_E_FILEALREADYOPEN           HRESULT = 1<<31 | 10<<16 | 55
	HRESULT_CTL_E_DEVICEIOERROR             HRESULT = 1<<31 | 10<<16 | 57
	HRESULT_CTL_E_FILEALREADYEXISTS         HRESULT = 1<<31 | 10<<16 | 58
	HRESULT_CTL_E_BADRECORDLENGTH           HRESULT = 1<<31 | 10<<16 | 59
	HRESULT_CTL_E_DISKFULL                  HRESULT = 1<<31 | 10<<16 | 61
	HRESULT_CTL_E_BADRECORDNUMBER           HRESULT = 1<<31 | 10<<16 | 63
	HRESULT_CTL_E_BADFILENAME               HRESULT = 1<<31 | 10<<16 | 64
	HRESULT_CTL_E_TOOMANYFILES              HRESULT = 1<<31 | 10<<16 | 67
	HRESULT_CTL_E_DEVICEUNAVAILABLE         HRESULT = 1<<31 | 10<<16 | 68
	HRESULT_CTL_E_PERMISSIONDENIED          HRESULT = 1<<31 | 10<<16 | 70
	HRESULT_CTL_E_DISKNOTREADY              HRESULT = 1<<31 | 10<<16 | 71
	HRESULT_CTL_E_PATHFILEACCESSERROR       HRESULT = 1<<31 | 10<<16 | 75
	HRESULT_CTL_E_PATHNOTFOUND              HRESULT = 1<<31 | 10<<16 | 76
	HRESULT_CTL_E_INVALIDPATTERNSTRING      HRESULT = 1<<31 | 10<<16 | 93
	HRESULT_CTL_E_INVALIDUSEOFNULL          HRESULT = 1<<31 | 10<<16 | 94
	HRESULT_CTL_E_INVALIDFILEFORMAT         HRESULT = 1<<31 | 10<<16 | 321
	HRESULT_CTL_E_INVALIDPROPERTYVALUE      HRESULT = 1<<31 | 10<<16 | 380
	HRESULT_CTL_E_INVALIDPROPERTYARRAYINDEX HRESULT = 1<<31 | 10<<16 | 381
	HRESULT_CTL_E_SETNOTSUPPORTEDATRUNTIME  HRESULT = 1<<31 | 10<<16 | 382
	HRESULT_CTL_E_SETNOTSUPPORTED           HRESULT = 1<<31 | 10<<16 | 383
	HRESULT_CTL_E_NEEDPROPERTYARRAYINDEX    HRESULT = 1<<31 | 10<<16 | 385
	HRESULT_CTL_E_SETNOTPERMITTED           HRESULT = 1<<31 | 10<<16 | 387
	HRESULT_CTL_E_GETNOTSUPPORTEDATRUNTIME  HRESULT = 1<<31 | 10<<16 | 393
	HRESULT_CTL_E_GETNOTSUPPORTED           HRESULT = 1<<31 | 10<<16 | 394
	HRESULT_CTL_E_PROPERTYNOTFOUND          HRESULT = 1<<31 | 10<<16 | 422
	HRESULT_CTL_E_INVALIDCLIPBOARDFORMAT    HRESULT = 1<<31 | 10<<16 | 460
	HRESULT_CTL_E_INVALIDPICTURE            HRESULT = 1<<31 | 10<<16 | 481
	HRESULT_CTL_E_PRINTERERROR              HRESULT = 1<<31 | 10<<16 | 482
	HRESULT_CTL_E_CANTSAVEFILETOTEMP        HRESULT = 1<<31 | 10<<16 | 735
	HRESULT_CTL_E_SEARCHTEXTNOTFOUND        HRESULT = 1<<31 | 10<<16 | 744
	HRESULT_CTL_E_REPLACEMENTSTOOLONG       HRESULT = 1<<31 | 10<<16 | 746

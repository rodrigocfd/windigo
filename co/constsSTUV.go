...
const (
	...
	SECTION_ALL_ACCESS           SECTION = 0x000F0000 | SECTION_QUERY | SECTION_MAP_WRITE | SECTION_MAP_READ | SECTION_MAP_EXECUTE | SECTION_EXTEND_SIZE // first is STANDARD_RIGHTS_REQUIRED
)

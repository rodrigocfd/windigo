...
// Oleaut IID identifier.
var (
	IID_IDispatch      = IID(GUID{0x00020400, 0x0000, 0x0000, [8]byte{0xc0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}})
	IID_IPicture       = IID(GUID{0x7bf80980, 0xbf32, 0x101a, [8]byte{0x8b, 0xbb, 0x00, 0xaa, 0x00, 0x30, 0x0c, 0xab}})
	IID_IPropertyStore = IID(GUID{0x886d8eeb, 0x8cf2, 0x4446, [8]byte{0x8d, 0x02, 0xcd, 0xba, 0x1d, 0xbd, 0xcf, 0x99}})
	IID_ITypeInfo      = IID(GUID{0x00020401, 0x0000, 0x0000, [8]byte{0xc0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}})
	IID_ITypeLib       = IID(GUID{0x00020402, 0x0000, 0x0000, [8]byte{0xc0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}})
)

...
const (
	...
	GWLP_DWLP_MSGRESULT GWLP = 0                       // Originally has DWLP prefix.
	GWLP_DWLP_DLGPROC        = GWLP_DWLP_MSGRESULT + 8 // Originally has DWLP prefix.
	GWLP_DWLP_USER           = GWLP_DWLP_DLGPROC + 8   // Originally has DWLP prefix.
)

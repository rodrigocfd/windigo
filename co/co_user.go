...
const (
	...
	DPI_AWARENESS_CONTEXT_SYSTEM_AWARE         = DPI_AWARENESS_CONTEXT(^uintptr(0) - 2)
	DPI_AWARENESS_CONTEXT_PER_MONITOR_AWARE    = DPI_AWARENESS_CONTEXT(^uintptr(0) - 3)
	DPI_AWARENESS_CONTEXT_PER_MONITOR_AWARE_V2 = DPI_AWARENESS_CONTEXT(^uintptr(0) - 4)
	DPI_AWARENESS_CONTEXT_UNAWARE_GDISCALED    = DPI_AWARENESS_CONTEXT(^uintptr(0) - 5)
)
...
// Power Setting [GUIDs].
//
// [GUIDs]: https://learn.microsoft.com/en-us/windows/win32/power/power-setting-guids
type POWER_GUID GUID

var (
	POWER_GUID_ACDC_SOURCE                  = POWER_GUID(GUID{0x5d3e9a59, 0xe9d5, 0x4b00, [8]byte{0xa6, 0xbd, 0xff, 0x34, 0xff, 0x51, 0x65, 0x48}})
	POWER_GUID_BATTERY_PERCENTAGE_REMAINING = POWER_GUID(GUID{0xa7ad8041, 0xb45a, 0x4cae, [8]byte{0x87, 0xa3, 0xee, 0xcb, 0xb4, 0x68, 0xa9, 0xe1}})
	POWER_GUID_CONSOLE_DISPLAY_STATE        = POWER_GUID(GUID{0x6fe69556, 0x704a, 0x47a0, [8]byte{0x8f, 0x24, 0xc2, 0x8d, 0x93, 0x6f, 0xda, 0x47}})
	POWER_GUID_GLOBAL_USER_PRESENCE         = POWER_GUID(GUID{0x786e8a1d, 0xb427, 0x4344, [8]byte{0x92, 0x07, 0x09, 0xe7, 0x0b, 0xdc, 0xbe, 0xa9}})
	POWER_GUID_IDLE_BACKGROUND_TASK         = POWER_GUID(GUID{0x515c31d8, 0xf734, 0x163d, [8]byte{0xa0, 0xfd, 0x11, 0xa0, 0x8c, 0x91, 0xe8, 0xf1}})
	POWER_GUID_LIDSWITCH_STATE_CHANGE       = POWER_GUID(GUID{0xba3e0f4d, 0xb817, 0x4094, [8]byte{0xa2, 0xd1, 0xd5, 0x63, 0x79, 0xe6, 0xa0, 0xf3}})
	POWER_GUID_MONITOR_POWER_ON             = POWER_GUID(GUID{0x02731015, 0x4510, 0x4526, [8]byte{0x99, 0xe6, 0xe5, 0xa1, 0x7e, 0xbd, 0x1a, 0xea}})
	POWER_GUID_POWER_SAVING_STATUS          = POWER_GUID(GUID{0xe00958c0, 0xc213, 0x4ace, [8]byte{0xac, 0x77, 0xfe, 0xcc, 0xed, 0x2e, 0xee, 0xa5}})
	POWER_GUID_ENERGY_SAVER_STATUS          = POWER_GUID(GUID{0x550e8400, 0xe29b, 0x41d4, [8]byte{0xa7, 0x16, 0x44, 0x66, 0x55, 0x44, 0x00, 0x00}})
	POWER_GUID_POWERSCHEME_PERSONALITY      = POWER_GUID(GUID{0x245d8541, 0x3943, 0x4422, [8]byte{0xb0, 0x25, 0x13, 0xa7, 0x84, 0xf6, 0x79, 0xb7}})
	POWER_GUID_MIN_POWER_SAVINGS            = POWER_GUID(GUID{0x8c5e7fda, 0xe8bf, 0x4a96, [8]byte{0x9a, 0x85, 0xa6, 0xe2, 0x3a, 0x8c, 0x63, 0x5c}})
	POWER_GUID_MAX_POWER_SAVINGS            = POWER_GUID(GUID{0xa1841308, 0x3541, 0x4fab, [8]byte{0xbc, 0x81, 0xf7, 0x15, 0x56, 0xf2, 0x0b, 0x4a}})
	POWER_GUID_TYPICAL_POWER_SAVINGS        = POWER_GUID(GUID{0x381b4222, 0xf694, 0x41f0, [8]byte{0x96, 0x85, 0xff, 0x5b, 0xb2, 0x60, 0xdf, 0x2e}})
	POWER_GUID_SESSION_DISPLAY_STATUS       = POWER_GUID(GUID{0x2b84c20e, 0xad23, 0x4ddf, [8]byte{0x93, 0xdb, 0x05, 0xff, 0xbd, 0x7e, 0xfc, 0xa5}})
	POWER_GUID_SESSION_USER_PRESENCE        = POWER_GUID(GUID{0x3c0f4548, 0xc03f, 0x4c4d, [8]byte{0xb9, 0xf2, 0x23, 0x7e, 0xde, 0x68, 0x63, 0x76}})
	POWER_GUID_SYSTEM_AWAYMODE              = POWER_GUID(GUID{0x98a7f580, 0x01f7, 0x48aa, [8]byte{0x9c, 0x0f, 0x44, 0x35, 0x2c, 0x29, 0xe5, 0xc0}})
)

...
const (
	...
	LVM_GETITEMRECT              LVM = lVM_FIRST + 14
	LVM_SETITEMPOSITION          LVM = lVM_FIRST + 15
	LVM_GETITEMPOSITION          LVM = lVM_FIRST + 16
	...
	LVM_ARRANGE                  LVM = lVM_FIRST + 22
	LVM_GETEDITCONTROL           LVM = lVM_FIRST + 24
	LVM_DELETECOLUMN             LVM = lVM_FIRST + 28
	...
	LVM_GETSUBITEMRECT           LVM = lVM_FIRST + 56
	LVM_SUBITEMHITTEST           LVM = lVM_FIRST + 57
	LVM_SETCOLUMNORDERARRAY      LVM = lVM_FIRST + 58
	LVM_GETCOLUMNORDERARRAY      LVM = lVM_FIRST + 59
	LVM_SETHOTITEM               LVM = lVM_FIRST + 60
	LVM_GETHOTITEM               LVM = lVM_FIRST + 61
	LVM_SETHOTCURSOR             LVM = lVM_FIRST + 62
	LVM_GETHOTCURSOR             LVM = lVM_FIRST + 63
	LVM_APPROXIMATEVIEWRECT      LVM = lVM_FIRST + 64
	LVM_SETWORKAREAS             LVM = lVM_FIRST + 65
	LVM_GETSELECTIONMARK         LVM = lVM_FIRST + 66
	LVM_SETSELECTIONMARK         LVM = lVM_FIRST + 67
	LVM_GETWORKAREAS             LVM = lVM_FIRST + 70
	LVM_SETHOVERTIME             LVM = lVM_FIRST + 71
	LVM_GETHOVERTIME             LVM = lVM_FIRST + 72
	LVM_GETNUMBEROFWORKAREAS     LVM = lVM_FIRST + 73
	...
	LVM_SORTITEMSEX              LVM = lVM_FIRST + 81
	LVM_FINDITEM                 LVM = lVM_FIRST + 83
	LVM_GETSTRINGWIDTH           LVM = lVM_FIRST + 87
	LVM_GETGROUPSTATE            LVM = lVM_FIRST + 92
	LVM_GETFOCUSEDGROUP          LVM = lVM_FIRST + 93
	LVM_GETCOLUMN                LVM = lVM_FIRST + 95
	LVM_SETCOLUMN                LVM = lVM_FIRST + 96
	LVM_INSERTCOLUMN             LVM = lVM_FIRST + 97
	LVM_GETGROUPRECT             LVM = lVM_FIRST + 98
	LVM_GETITEMTEXT              LVM = lVM_FIRST + 115
	LVM_SETITEMTEXT              LVM = lVM_FIRST + 116
	LVM_GETISEARCHSTRING         LVM = lVM_FIRST + 117
	LVM_EDITLABEL                LVM = lVM_FIRST + 118
	LVM_SETBKIMAGE               LVM = lVM_FIRST + 138
	LVM_GETBKIMAGE               LVM = lVM_FIRST + 139
	LVM_SETSELECTEDCOLUMN        LVM = lVM_FIRST + 140
	LVM_SETVIEW                  LVM = lVM_FIRST + 142
	LVM_GETVIEW                  LVM = lVM_FIRST + 143
	LVM_INSERTGROUP              LVM = lVM_FIRST + 145
	LVM_SETGROUPINFO             LVM = lVM_FIRST + 147
	LVM_GETGROUPINFO             LVM = lVM_FIRST + 149
	LVM_REMOVEGROUP              LVM = lVM_FIRST + 150
	LVM_MOVEGROUP                LVM = lVM_FIRST + 151
	LVM_GETGROUPCOUNT            LVM = lVM_FIRST + 152
	LVM_GETGROUPINFOBYINDEX      LVM = lVM_FIRST + 153
	LVM_MOVEITEMTOGROUP          LVM = lVM_FIRST + 154
	LVM_SETGROUPMETRICS          LVM = lVM_FIRST + 155
	LVM_GETGROUPMETRICS          LVM = lVM_FIRST + 156
	LVM_ENABLEGROUPVIEW          LVM = lVM_FIRST + 157
	LVM_SORTGROUPS               LVM = lVM_FIRST + 158
	LVM_INSERTGROUPSORTED        LVM = lVM_FIRST + 159
	LVM_REMOVEALLGROUPS          LVM = lVM_FIRST + 160
	LVM_HASGROUP                 LVM = lVM_FIRST + 161
	LVM_SETTILEVIEWINFO          LVM = lVM_FIRST + 162
	LVM_GETTILEVIEWINFO          LVM = lVM_FIRST + 163
	LVM_SETTILEINFO              LVM = lVM_FIRST + 164
	LVM_GETTILEINFO              LVM = lVM_FIRST + 165
	LVM_SETINSERTMARK            LVM = lVM_FIRST + 166
	LVM_GETINSERTMARK            LVM = lVM_FIRST + 167
	LVM_INSERTMARKHITTEST        LVM = lVM_FIRST + 168
	LVM_GETINSERTMARKRECT        LVM = lVM_FIRST + 169
	LVM_SETINSERTMARKCOLOR       LVM = lVM_FIRST + 170
	LVM_GETINSERTMARKCOLOR       LVM = lVM_FIRST + 171
	LVM_SETINFOTIP               LVM = lVM_FIRST + 173
	LVM_GETSELECTEDCOLUMN        LVM = lVM_FIRST + 174
	LVM_ISGROUPVIEWENABLED       LVM = lVM_FIRST + 175
	LVM_GETOUTLINECOLOR          LVM = lVM_FIRST + 176
	LVM_SETOUTLINECOLOR          LVM = lVM_FIRST + 177
	LVM_CANCELEDITLABEL          LVM = lVM_FIRST + 179
	LVM_MAPINDEXTOID             LVM = lVM_FIRST + 180
	LVM_MAPIDTOINDEX             LVM = lVM_FIRST + 181
	LVM_ISITEMVISIBLE            LVM = lVM_FIRST + 182
	LVM_GETEMPTYTEXT             LVM = lVM_FIRST + 204
	LVM_GETFOOTERRECT            LVM = lVM_FIRST + 205
	LVM_GETFOOTERINFO            LVM = lVM_FIRST + 206
	LVM_GETFOOTERITEMRECT        LVM = lVM_FIRST + 207
	LVM_GETFOOTERITEM            LVM = lVM_FIRST + 208
	LVM_GETITEMINDEXRECT         LVM = lVM_FIRST + 209
	LVM_SETITEMINDEXSTATE        LVM = lVM_FIRST + 210
	LVM_GETNEXTITEMINDEX         LVM = lVM_FIRST + 211
)

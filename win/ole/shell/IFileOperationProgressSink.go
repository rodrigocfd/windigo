	...
	if me.QueryInterface == 0 { // initialize only once
		*me = _IFileOperationProgressSinkVt{
			...
			PreRenameItem: syscall.NewCallback(
				func(p uintptr, dwFlags uint32, psiItem **ole.IUnknownVt, pszNewName *uint16) uintptr {
					ppImpl := (**_IFileOperationProgressSinkImpl)(unsafe.Pointer(p))
			...
			PostRenameItem: syscall.NewCallback(
				func(p uintptr,
					dwFlags uint32,
					psiItem **ole.IUnknownVt,
					pszNewName *uint16,
					hrRename co.HRESULT,
					psiNewlyCreated **ole.IUnknownVt,
				) uintptr {
					ppImpl := (**_IFileOperationProgressSinkImpl)(unsafe.Pointer(p))
			...
			PreMoveItem: syscall.NewCallback(
				func(p uintptr,
					dwFlags uint32,
					psiItem, psiDestinationFolder **ole.IUnknownVt,
					pszNewName *uint16,
				) uintptr {
					ppImpl := (**_IFileOperationProgressSinkImpl)(unsafe.Pointer(p))
			...
			PreDeleteItem: syscall.NewCallback(
				func(p uintptr, dwFlags uint32, psiItem **ole.IUnknownVt) uintptr {
					ppImpl := (**_IFileOperationProgressSinkImpl)(unsafe.Pointer(p))
			...
			PreNewItem: syscall.NewCallback(
				func(p uintptr,
					dwFlags uint32,
					psiDestinationFolder **ole.IUnknownVt,
					pszNewName *uint16,
				) uintptr {
					ppImpl := (**_IFileOperationProgressSinkImpl)(unsafe.Pointer(p))

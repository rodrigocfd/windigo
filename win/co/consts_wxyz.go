...
const (
	...
	WS_EX_TOOLWINDOW          WS_EX = 0x00000080 // The window is intended to be used as a floating toolbar.
	WS_EX_WINDOWEDGE          WS_EX = 0x00000100 // The window has a border with a raised edge.
	...
	WS_EX_LEFT                WS_EX = 0x00000000 // The window has generic left-aligned properties. This is the default.
	WS_EX_RTLREADING          WS_EX = 0x00002000
	WS_EX_LTRREADING          WS_EX = 0x00000000 // The window text is displayed using left-to-right reading-order properties. This is the default.
	WS_EX_LEFTSCROLLBAR       WS_EX = 0x00004000
	WS_EX_RIGHTSCROLLBAR      WS_EX = 0x00000000 // The vertical scroll bar (if present) is to the right of the client area. This is the default.
	WS_EX_CONTROLPARENT       WS_EX = 0x00010000
	WS_EX_STATICEDGE          WS_EX = 0x00020000 // The window has a three-dimensional border style intended to be used for items that do not accept user input.
	...
	WS_EX_NOINHERITLAYOUT     WS_EX = 0x00100000 // The window does not pass its window layout to its child windows.

...
const (
	CKS_CAPSLOCK_ON        CKS = 0x0080
	CKS_ENHANCED_KEY       CKS = 0x0100
	CKS_LEFT_ALT_PRESSED   CKS = 0x0002
	CKS_LEFT_CTRL_PRESSED  CKS = 0x0008
	CKS_NUMLOCK_ON         CKS = 0x0020
	CKS_RIGHT_ALT_PRESSED  CKS = 0x0001
	CKS_RIGHT_CTRL_PRESSED CKS = 0x0004
	CKS_SCROLLLOCK_ON      CKS = 0x0040
	CKS_SHIFT_PRESSED      CKS = 0x0010
)
...
const (
	...
	FILE_MAP_WRITE                    = _SECTION_MAP_WRITE
	FILE_MAP_READ                     = _SECTION_MAP_READ
	FILE_MAP_ALL_ACCESS               = _SECTION_ALL_ACCESS
	FILE_MAP_EXECUTE                  = _SECTION_MAP_EXECUTE_EXPLICIT
...
const (
	...
	GMEM_NOCOMPACT      GMEM = 0x0010
	GMEM_NODISCARD      GMEM = 0x0020
	GMEM_ZEROINIT       GMEM = 0x0040
	GMEM_MODIFY         GMEM = 0x0080
	GMEM_DISCARDABLE    GMEM = 0x0100
	GMEM_NOT_BANKED     GMEM = 0x1000
	GMEM_SHARE          GMEM = 0x2000
	GMEM_DDESHARE       GMEM = 0x2000
	GMEM_NOTIFY         GMEM = 0x4000
	GMEM_LOWER               = GMEM_NOT_BANKED
	GMEM_VALID_FLAGS    GMEM = 0x7f72
	GMEM_INVALID_HANDLE GMEM = 0x8000
	GMEM_GHND                = GMEM_MOVEABLE | GMEM_ZEROINIT
	GMEM_GPTR                = GMEM_FIXED | GMEM_ZEROINIT
	GMEM_DISCARDED      GMEM = 0x4000
...
const (
	...
	LMEM_NOCOMPACT      LMEM = 0x0010
	LMEM_NODISCARD      LMEM = 0x0020
	LMEM_ZEROINIT       LMEM = 0x0040
	LMEM_MODIFY         LMEM = 0x0080
	LMEM_DISCARDABLE    LMEM = 0x0f00
	LMEM_VALID_FLAGS    LMEM = 0x0f72
	LMEM_INVALID_HANDLE LMEM = 0x8000
	LMEM_LHND                = LMEM_MOVEABLE | LMEM_ZEROINIT
	LMEM_LPTR                = LMEM_FIXED | LMEM_ZEROINIT
	LMEM_NONZEROLHND         = LMEM_MOVEABLE
	LMEM_NONZEROLPTR         = LMEM_FIXED
	LMEM_DISCARDED      LMEM = 0x4000
	LMEM_LOCKCOUNT      LMEM = 0x00ff
)
